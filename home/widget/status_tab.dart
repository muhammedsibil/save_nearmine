...
class _StatusTabState extends State<StatusTab> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.separated(
      ...
      itemBuilder: (ctx, i) {
        return ListTile(
          title: Text(chatListItems[i].personName.toString()),
          subtitle: Text(chatListItems[i].date.toString()),
          leading: CircleAvatar(
            backgroundColor: Colors.grey,
            backgroundImage:
                NetworkImage(chatListItems[i].profileURL.toString()),
          ),
          onTap: () {
            // Navigator.push(
            //   context,
