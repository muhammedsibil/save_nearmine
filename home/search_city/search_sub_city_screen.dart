...
class SearchSubCityScreen extends StatefulWidget {
  const SearchSubCityScreen({Key? key}) : super(key: key);

  @override
  State<SearchSubCityScreen> createState() => _SearchSubCityScreenState();
}

class _SearchSubCityScreenState extends State<SearchSubCityScreen> {
  var city;
  var subCity;
    ...
    return SafeArea(
      child: Scaffold(
        body: SingleChildScrollView(
          ...
          searchBox(number, nameShop, ownership),
          // hhh ? CircularProgressIndicator() : SizedBox(),
          subCityList(number, nameShop, ownership),
        ])),
          ...
          itemBuilder: (context, index) {
            ...
            return ListTile(
              onTap: () {
                ...
                //       builder: (context, cityModel, child) {
                ...
                String ownership =
                    Provider.of<CityModel>(context, listen: false).ownership;
                if (ownership == "Bussiness") {
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => UserTab(),
                  ));
...
class BridgeNavigate extends StatefulWidget {
  const BridgeNavigate({super.key, required this.subCity, required this.city});
  final String subCity;
  final String city;
  @override
  State<BridgeNavigate> createState() => _BridgeNavigateState();
}

class _BridgeNavigateState extends State<BridgeNavigate> {
  @override
  Widget build(BuildContext context) {
    // Navigator.push(
    //   context,
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      context.read<CityModel>().addCity(widget.city, widget.subCity);
    });
